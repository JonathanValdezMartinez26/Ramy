 ...
 * @author RojeruSan
 */
public class ConfigCotizacionAyuda extends javax.swing.JDialog {
     ...
     */
    public ConfigCotizacionAyuda(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        //CargarDatos();
        initComponents();
    ...
    ResultSet resultado;
     int IDD;
       private ConfigCotizacionAyuda VE;

    public void setVE(ConfigCotizacionAyuda  VE) {
        this.VE = VE;
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/cotizacionA.PNG"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConfigCotizacionAyuda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ConfigCotizacionAyuda dialog = new ConfigCotizacionAyuda(new javax.swing.JFrame(), true);
