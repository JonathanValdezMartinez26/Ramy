 ...
 * @author RojeruSan
 */
public class ConfigCotizacionD extends javax.swing.JDialog {
     ...
     */
    public ConfigCotizacionD(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        //CargarDatos();
        initComponents();
    ...
    ResultSet resultado;
     int IDD;
       private ConfigCotizacionD VE;

    public void setVE(ConfigCotizacionD  VE) {
        this.VE = VE;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConfigCotizacionD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ConfigCotizacionD dialog = new ConfigCotizacionD(new javax.swing.JFrame(), true);
