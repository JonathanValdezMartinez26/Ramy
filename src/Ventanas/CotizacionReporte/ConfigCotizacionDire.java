 ...
 * @author RojeruSan
 */
public class ConfigCotizacionDire extends javax.swing.JDialog {
     ...
     */
    public ConfigCotizacionDire(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        //CargarDatos();
        initComponents();
    ...
    ResultSet resultado;
     int IDD;
       private ConfigCotizacionDire VE;

    public void setVE(ConfigCotizacionDire  VE) {
        this.VE = VE;
    }
    ...
    private void initComponents() {
        ...
        info.setText(" Cotización por Flete Directo");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConfigCotizacionDire.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ConfigCotizacionDire dialog = new ConfigCotizacionDire(new javax.swing.JFrame(), true);
