 ...
 * @author RojeruSan
 */
public class ConfigCotizacionbitaAju extends javax.swing.JDialog {
     ...
     */
    public ConfigCotizacionbitaAju(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        //CargarDatos();
        initComponents();
    ...
    ResultSet resultado;
     int IDD;
       private ConfigCotizacionbitaAju VE;

    public void setVE(ConfigCotizacionbitaAju  VE) {
        this.VE = VE;
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/bitaAju.PNG"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConfigCotizacionbitaAju.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ConfigCotizacionbitaAju dialog = new ConfigCotizacionbitaAju(new javax.swing.JFrame(), true);
