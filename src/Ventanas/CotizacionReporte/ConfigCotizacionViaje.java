 ...
 * @author RojeruSan
 */
public class ConfigCotizacionViaje extends javax.swing.JDialog {
     ...
     */
    public ConfigCotizacionViaje(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        //CargarDatos();
        initComponents();
    ...
    ResultSet resultado;
     int IDD;
       private ConfigCotizacionViaje VE;

    public void setVE(ConfigCotizacionViaje  VE) {
        this.VE = VE;
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/Viaje.PNG"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConfigCotizacionViaje.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ConfigCotizacionViaje dialog = new ConfigCotizacionViaje(new javax.swing.JFrame(), true);
