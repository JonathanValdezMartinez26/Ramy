 ...
 * @author RojeruSan
 */
public class ConfigCotizacionclienteayuda extends javax.swing.JDialog {
     ...
     */
    public ConfigCotizacionclienteayuda(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        //CargarDatos();
        initComponents();
    ...
    ResultSet resultado;
     int IDD;
       private ConfigCotizacionclienteayuda VE;

    public void setVE(ConfigCotizacionclienteayuda  VE) {
        this.VE = VE;
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/ClienteAyuda.PNG"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConfigCotizacionclienteayuda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ConfigCotizacionclienteayuda dialog = new ConfigCotizacionclienteayuda(new javax.swing.JFrame(), true);
