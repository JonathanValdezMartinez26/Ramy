...
public class pnlPass_1 extends javax.swing.JDialog {

    int x, y;
    private boolean camposCorrectos = false;
    private String nombreActual = "";
    
    public pnlPass_1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void logActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_logActionPerformed
        ...
        if (!"".equals(Pass) && !"".equals(Pass1) && !"".equals(Pass2)) {
            ...
            try 
            {
                ...
                if (camposCorrectos) 
                {
                    if (Funciones.actualizarPass(Ventanas.Modulo_Consulta.Principal_Medico.lblIDActivo.getText(), this.txtPass1.getText())) 
                    {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                pnlPass dialog = new pnlPass(new javax.swing.JFrame(), true);
