...
public class pnlUser_1 extends javax.swing.JDialog {

    int x, y;
    private boolean camposCorrectos = false;
    private String nombreActual = "";
    
    public pnlUser_1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel14.setText("Cuenta Estándar");
    ...
    private void logActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_logActionPerformed
        if (this.txtUser.getText().length() == 0 || this.txtPass.getText().length() == 0) {
            ...
            if (Ventanas.Modulo_Usuario.Opciones.verificaUsuario(this.txtUser.getText()).equals(this.txtUser.getText())
                    && !this.txtUser.getText().equals(Ventanas.Modulo_Consulta.Principal_Medico.lblUserActivo.getText())) {
                this.lblNombreNuevo.setText("El nombre de usuario ya existe.");
                camposCorrectos = false;
                this.txtUser.requestFocus();
            }
            String pass = Funciones.verificaPassword(Ventanas.Modulo_Consulta.Principal_Medico.lblUserActivo.getText());
            System.out.println("");
            ...
            if (camposCorrectos) {
                nombreActual = Ventanas.Modulo_Consulta.Principal_Medico.lblUserActivo.getText();               
                if (Funciones.actualizarUs(Ventanas.Modulo_Consulta.Principal_Medico.lblIDActivo.getText(), this.txtUser.getText())) {
                    DesktopNotify.showDesktopMessage("CAMBIAR NOMBRE DE USUARIO...", "Has cambiado el nombre de usuario: "
                        +nombreActual+" por: "+Funciones.obtenerUsuario(Ventanas.Modulo_Consulta.Principal_Medico.lblIDActivo.getText()), DesktopNotify.INFORMATION, 8000);
                   Ventanas.Modulo_Consulta.Principal_Medico.lblUserActivo.setText(Funciones.obtenerUsuario(Ventanas.Modulo_Consulta.Principal_Medico.lblIDActivo.getText()));
                   this.dispose();      
                }
            }
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                pnlUser dialog = new pnlUser(new javax.swing.JFrame(), true);
