...
public class AgregarTipoServicio extends javax.swing.JDialog {

     int x, y;
    
    public AgregarTipoServicio(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        AWTUtilities.setOpaque(this, false);
        setLocationRelativeTo(null);
        this.txtTipo_Servicio.requestFocus();
    }

    public void Guardar(){
        String Nombre = txtTipo_Servicio.getText().trim();
        ...
        if("".equals(Nombre)){
            ...
            AC.setVisible(true);
             ...
             if(Ventanas.Modulo_Tipo_Servicio.Opciones.verificaTipo(Nombre) == 0)
                {
                    Tipo_Servicio.Agregar_Tipo(Nombre);
                    Opciones.listar("");
                    this.dispose();
                }
            else{
    ...
    private void initComponents() {
        ...
        txtTipo_Servicio = new app.bolivia.swing.JCTextField();
        ...
        info.setText("Agregar Tipo de Servicio");
    ...
    private void txtTipo_ServicioKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtTipo_ServicioKeyTyped
        ...
        int limite =25;
        if (txtTipo_Servicio.getText().length()== limite)
        {
            evt.consume();
        }
    }//GEN-LAST:event_txtTipo_ServicioKeyTyped
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AgregarTipoServicio dialog = new AgregarTipoServicio(new javax.swing.JFrame(), true);
    ...
    public static app.bolivia.swing.JCTextField txtTipo_Servicio;
