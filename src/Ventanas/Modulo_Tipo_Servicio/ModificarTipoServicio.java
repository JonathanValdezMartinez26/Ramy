...
public class ModificarTipoServicio extends javax.swing.JDialog {

     int x, y;
     
    
    public ModificarTipoServicio(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    ResultSet resultado;
     int IDD;
       private pnlTipoServicio VE;

    public void setVE(pnlTipoServicio VE) {
        this.VE = VE;
    }
    ...
    public void CargarDatos(int ID){
        ...
        try{
            ...
            resultado = Conexion.consulta("Select * from Tipo_Servicio Where ID_Tipo_Servicio = "+ID);
            
            while(resultado.next()){
             IDD = resultado.getInt(1);
             Nombre_Tipo_Servicio = resultado.getString(2);
             
            }
            
        }catch(SQLException ex){}
        
        txtNombre.setText(Nombre_Tipo_Servicio);

    }
       public void Guardar(){
        String Nombre_Tipo_Servicio = txtNombre.getText().trim();
        
        
        if("".equals(Nombre_Tipo_Servicio))
        {
    ...
    private void initComponents() {
        ...
        info.setText("Modificar Tipo de Servicio");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ModificarTipoServicio dialog = new ModificarTipoServicio(new javax.swing.JFrame(), true);
