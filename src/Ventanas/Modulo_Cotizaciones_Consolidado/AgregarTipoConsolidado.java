...
import Ventanas.Modulo_Cotizaciones_Consolidado.AgregarTipoConsolidado;
import Ventanas.Modulo_Cotizaciones_Consolidado.Opciones;
import Alerts.*;
import Alerts.AWTUtilities;
import Clases.CotizacionesConsolidado;
import Clases.CotizacionesConsolidado;
import java.awt.*;
...
public class AgregarTipoConsolidado extends javax.swing.JDialog {

     int x, y;
    
    public AgregarTipoConsolidado(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        AWTUtilities.setOpaque(this, false);
        setLocationRelativeTo(null);
        this.txtTipo_Consolidado.requestFocus();
    }

    public void Guardar(){
        String Nombre = txtTipo_Consolidado.getText().trim();
        ...
        if("".equals(Nombre)){
            ...
            AC.setVisible(true);
             ...
             if(Ventanas.Modulo_Cotizaciones_Consolidado.Opciones.verificaTipo(Nombre) == 0)
                {
                    CotizacionesConsolidado.Agregar_Tipo(Nombre);
                    Opciones.listar1("");
                    this.dispose();
                }
            else{
    ...
    private void initComponents() {
        ...
        txtTipo_Consolidado = new app.bolivia.swing.JCTextField();
        ...
        txtTipo_Consolidado.setBorder(null);
        txtTipo_Consolidado.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        txtTipo_Consolidado.setPlaceholder("Ej. Caja");
        txtTipo_Consolidado.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txtTipo_ConsolidadoKeyTyped(evt);
            }
        });
        pnlPrincipal.add(txtTipo_Consolidado, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 150, 230, 30));
        ...
        jLabel13.setText("  Nombre del Tipo de Consolidado");
        ...
        info.setText("Agregar Tipo de consolidado");
    ...
    private void txtTipo_ConsolidadoKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtTipo_ConsolidadoKeyTyped
        ...
        int limite =25;
        if (txtTipo_Consolidado.getText().length()== limite)
        {
            evt.consume();
        }
    }//GEN-LAST:event_txtTipo_ConsolidadoKeyTyped
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AgregarTipoConsolidado dialog = new AgregarTipoConsolidado(new javax.swing.JFrame(), true);
    ...
    public static app.bolivia.swing.JCTextField txtTipo_Consolidado;
