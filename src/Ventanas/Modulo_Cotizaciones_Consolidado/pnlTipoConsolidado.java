...
import Ventanas.Modulo_Tipo_Transportes.*;
import Ventanas.Modulo_Cotizaciones_Consolidado.Opciones;
import Ventanas.Modulo_Cotizaciones_Consolidado.pnlTipoConsolidado;
...
public class pnlTipoConsolidado extends javax.swing.JDialog {

   
    int i = 32;
    int x,y;
    
    public pnlTipoConsolidado(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        Opciones.listar1("");
...
//            ME.setVE(this);
    ...
    private void initComponents() {
        ...
        pnlagregar.setToolTipText("Agregar Tipo de Transporte");
        ...
        pnleditar.setToolTipText("Editar Tipo de Transporte");
    ...
    private void pnlagregarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pnlagregarMouseClicked
        AgregarTipoConsolidado poper = new AgregarTipoConsolidado(null, true);
    ...
    private void buscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_buscarKeyReleased
        Opciones.listar1(this.buscar.getText());
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                pnlTipoConsolidado dialog = new pnlTipoConsolidado(new javax.swing.JFrame(), true);
