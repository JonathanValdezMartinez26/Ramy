...
public class pnlCitasMedico extends javax.swing.JPanel {

    public pnlCitasMedico() {
        initComponents();
        tabla.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
        this.tabla.getTableHeader().setReorderingAllowed(false) ;
        this.tabla.getTableHeader().setDefaultRenderer(new EstiloTablaHeader());
        this.tabla.setDefaultRenderer(Object.class, new EstiloTablaRendererCitasMedico());
        ...
        if(buscar.equals(""))
        {
            Opciones.listarCitasBuscar("", Integer.parseInt(Principal_Medico.lblIDMedico.getText()));
        }
        else
        {
            Opciones.listarCitasBuscar(buscar.getText(), Integer.parseInt(Principal_Medico.lblIDMedico.getText()));
        }
    ...
    private void initComponents() {
        ...
        jPanel12.add(pnlmodificar, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 0, -1, 69));
