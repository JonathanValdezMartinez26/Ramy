...
public class ModificarTran extends javax.swing.JDialog {

     int x, y;
     
    
    public ModificarTran(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
     ...
     int ID_Esp [];
     int IDD;
     private pnlTransportes VM;
    
     public void setVM(pnlTransportes VM) {
        this.VM = VM;
    }
    ...
    public void CargarDatos(int ID){
        ...
        try{
            ...
            resultado = Conexion.consulta("Select * from Transportes Where ID_Transporte = "+ID);
            
            while(resultado.next()){
             IDD = resultado.getInt(1);
             Nombre = resultado.getString(2);
             Transporte = resultado.getString(3);
            }
            
        }catch(SQLException ex){}
        
        txtNombre.setText(Nombre);
        cmbTran.setSelectedItem(Transporte);
     ...
     public void Guardar(){
        ...
        int ID_Tipo_Transporte = ID_Esp[cmbEsp];
        
        if("".equals(Nombre_Transporte)||cmbEsp==0)
        {
            ...
            {
                Transporte.Actualizar_Transportes(IDD, Nombre_Transporte, ID_Tipo_Transporte);
                Opciones.listar("");
                this.dispose();
            }
    ...
    public void CargarTransporte(){
     ...
     int ID_Tipo_Transporte = 0;
     
      try{
         
     resultado = Conexion.consulta("Select Max(ID_Tipo_Transporte) from Tipo_Transporte");
         
     while(resultado.next()){
         ID_Tipo_Transporte = resultado.getInt(1);
     }
     }catch(SQLException ex){
      ...
      ID_Esp = new int[ID_Tipo_Transporte];
     ...
     resultado = Conexion.consulta("Select ID_Tipo_Transporte, Tipo_Transporte from Tipo_Transporte");
    ...
    private void initComponents() {
        ...
        jcMousePanel1.add(pnlPrincipal, new org.netbeans.lib.awtextra.AbsoluteConstraints(7, 6, 350, 280));
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ModificarTran dialog = new ModificarTran(new javax.swing.JFrame(), true);
