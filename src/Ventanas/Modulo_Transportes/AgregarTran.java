...
public class AgregarTran extends javax.swing.JDialog {

     int x, y;
     ResultSet resultado;
     int ID_Tipo [];
    
    public AgregarTran(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
      ...
      try
        ...
        catch(SQLException ex)
        {
            ...
            ID_Tipo_Transporte++;
            ID_Tipo = new int[ID_Tipo_Transporte];
    ...
    public void Guardar(){
        ...
        int ID_Tipo_Transporte = ID_Tipo[cmbTip];
     
        
        if("".equals(Nombre)||cmbTip==0)
        {
        ...
        else
        {
            ...
            {
               if(Ventanas.Modulo_Transportes.Opciones.verificaTran(Nombre) == 0)
                {
                    Transporte.Agregar_Tipo(Nombre,ID_Tipo_Transporte);
                    Opciones.listar("");
                    this.dispose();
                }
                else
    ...
    private void initComponents() {
        ...
        info.setText("Agregar Transporte");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AgregarTran dialog = new AgregarTran(new javax.swing.JFrame(), true);
