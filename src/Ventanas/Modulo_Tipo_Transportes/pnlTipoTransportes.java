...
public class pnlTipoTransportes extends javax.swing.JDialog {

   
    int i = 32;
    int x,y;
    
    public pnlTipoTransportes(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        Opciones.listar("");
     ...
     public void Modificar()
    {
            ...
            if(Fila >= 0)
        {
            ...
            ModificarTipoTransporte ME = new ModificarTipoTransporte(null, true);
            ME.CargarDatos(ID);
//            ME.setVE(this);
            ME.setVisible(true);
        }
    ...
    private void initComponents() {
        ...
        info.setText("Tipo de Transporte");
        ...
        pnlagregar.setToolTipText("Agregar Especialidad");
        ...
        pnleditar.setToolTipText("Editar Especialidad");
        ...
        pnlPrincipal.add(jPanel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 711, -1));
        ...
        jcMousePanel1.add(pnlPrincipal, new org.netbeans.lib.awtextra.AbsoluteConstraints(14, 40, 711, 450));
    ...
    private void pnlagregarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pnlagregarMouseClicked
        AgregarTipoTransporte poper = new AgregarTipoTransporte(null, true);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                pnlTipoTransportes dialog = new pnlTipoTransportes(new javax.swing.JFrame(), true);
