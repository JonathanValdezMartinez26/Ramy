...
public class EditarClienteTrailer extends AbstractCellEditor implements TableCellEditor{
    ...
    public EditarClienteTrailer(database db, String NameColumn)
    {
            this.db = db;
    ...
    public boolean stopCellEditing() {
        ...
        {   //Realiza la actualizacion
            if( !db.updateClienteTrailer(NewValue, ID ) )
