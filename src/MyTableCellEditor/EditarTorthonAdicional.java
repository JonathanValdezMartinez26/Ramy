...
public class EditarTorthonAdicional extends AbstractCellEditor implements TableCellEditor{
    ...
    public EditarTorthonAdicional(database db, String NameColumn)
    {
            this.db = db;
...
//       if(!NewValue.equals(vacio)){ 
        ...
        {   //Realiza la actualizacion
            if( !db.updateTorthon(NewValue, ID ) )
