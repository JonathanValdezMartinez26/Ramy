...
public class EditarClienteCamioneta35 extends AbstractCellEditor implements TableCellEditor{
    ...
    public EditarClienteCamioneta35(database db, String NameColumn)
    {
            this.db = db;
    ...
    public boolean stopCellEditing() {
        ...
        {   //Realiza la actualizacion
            if( !db.updateClienteCamioneta35(NewValue, ID ) )
