...
public class EditarCotizGTrailer extends AbstractCellEditor implements TableCellEditor{
    ...
    public EditarCotizGTrailer(database db, String NameColumn)
    {
            this.db = db;
    ...
    public boolean stopCellEditing() {
        ...
        {   //Realiza la actualizacion
            if( !db.updateViajeModTrailer(NewValue, ID ) )
