...
public class EditarRabonAdicional extends AbstractCellEditor implements TableCellEditor{
    ...
    public EditarRabonAdicional(database db, String NameColumn)
    {
            this.db = db;
