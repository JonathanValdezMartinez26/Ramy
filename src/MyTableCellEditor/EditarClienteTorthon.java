...
public class EditarClienteTorthon extends AbstractCellEditor implements TableCellEditor{
    ...
    public EditarClienteTorthon(database db, String NameColumn)
    {
            this.db = db;
    ...
    public boolean stopCellEditing() {
        ...
        {   //Realiza la actualizacion
            if( !db.updateClienteTorthon(NewValue, ID ) )
