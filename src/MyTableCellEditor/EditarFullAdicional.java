...
public class EditarFullAdicional extends AbstractCellEditor implements TableCellEditor{
    ...
    public EditarFullAdicional(database db, String NameColumn)
    {
            this.db = db;
