...
public class EditarCotizGRabon extends AbstractCellEditor implements TableCellEditor{
    ...
    public EditarCotizGRabon(database db, String NameColumn)
    {
            this.db = db;
    ...
    public boolean stopCellEditing() {
        ...
        {   //Realiza la actualizacion
            if( !db.updateViajeModRabon(NewValue, ID ) )
