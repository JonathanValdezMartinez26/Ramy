...
public class EditarCotizGTorthon extends AbstractCellEditor implements TableCellEditor{
    ...
    public EditarCotizGTorthon(database db, String NameColumn)
    {
            this.db = db;
    ...
    public boolean stopCellEditing() {
        ...
        {   //Realiza la actualizacion
            if( !db.updateViajeModTorthon(NewValue, ID ) )
