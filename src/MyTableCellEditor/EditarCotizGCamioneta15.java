...
public class EditarCotizGCamioneta15 extends AbstractCellEditor implements TableCellEditor{
    ...
    public EditarCotizGCamioneta15(database db, String NameColumn)
    {
            this.db = db;
    ...
    public Component getTableCellEditorComponent(JTable table, Object value, boolean isSelected, int row, int column) {
        try
        {
            ...
            destino = table.getValueAt(row,3).toString();//obtiene el ID unico del registro            
    ...
    public boolean stopCellEditing() {
        ...
        {   //Realiza la actualizacion
            if( !db.updateViajeModCamioneta15(NewValue, ID ) )
            ...
            ///////////////////////////Si no exixste ninguna excepcion se realiza el registro en la bitacora
                ...
                if(db.insertBitacoraModificacion(origen+"  -  "+destino,OldValue,NewValue,NameColum,ID2 ) )
                {   
