...
public class EditarClienteFull extends AbstractCellEditor implements TableCellEditor{
    ...
    public EditarClienteFull(database db, String NameColumn)
    {
            this.db = db;
    ...
    public boolean stopCellEditing() {
        ...
        {   //Realiza la actualizacion
            if( !db.updateClienteFull(NewValue, ID ) )
