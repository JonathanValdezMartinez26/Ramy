...
public class EditarClienteRabon extends AbstractCellEditor implements TableCellEditor{
    ...
    public EditarClienteRabon(database db, String NameColumn)
    {
            this.db = db;
    ...
    public boolean stopCellEditing() {
        ...
        {   //Realiza la actualizacion
            if( !db.updateClienteRabon(NewValue, ID ) )
