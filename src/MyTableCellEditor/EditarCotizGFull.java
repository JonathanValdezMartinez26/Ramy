...
public class EditarCotizGFull extends AbstractCellEditor implements TableCellEditor{
    ...
    public EditarCotizGFull(database db, String NameColumn)
    {
            this.db = db;
    ...
    public boolean stopCellEditing() {
        ...
        {   //Realiza la actualizacion
            if( !db.updateViajeModFull(NewValue, ID ) )
