...
public class EditarCotizGCamioneta35 extends AbstractCellEditor implements TableCellEditor{
    ...
    public EditarCotizGCamioneta35(database db, String NameColumn)
    {
            this.db = db;
    ...
    public boolean stopCellEditing() {
        ...
        {   //Realiza la actualizacion
            if( !db.updateViajeModCamioneta35(NewValue, ID ) )
