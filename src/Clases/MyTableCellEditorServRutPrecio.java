...
public class MyTableCellEditorServRutPrecio extends AbstractCellEditor implements TableCellEditor{
    ...
    public MyTableCellEditorServRutPrecio(database db, String NameColumn)
    {
            this.db = db;
