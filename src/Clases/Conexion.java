...
public static ResultSet consulta(String sql)throws SQLException{
  ...
  public Connection conexion() {
        try {
            ...
            con = DriverManager.getConnection("jdbc:mysql://64.34.157.80:3306/ramy8102_ctz_01?useUnicode=true&useJDBCCompilantTimezoneShift=true","ramy8102_ctz_01", "RAMY_001CTZ");
