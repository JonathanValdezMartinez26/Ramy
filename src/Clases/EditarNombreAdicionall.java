...
public class EditarNombreAdicionall extends AbstractCellEditor implements TableCellEditor{
    ...
    public EditarNombreAdicionall(database db, String NameColumn)
    {
            this.db = db;
...
//       if(!NewValue.equals(vacio)){ 
        ...
        {   //Realiza la actualizacion
            if( !db.updateNombreAdicional(NewValue, ID ) )
