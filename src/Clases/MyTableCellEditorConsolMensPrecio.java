...
public class MyTableCellEditorConsolMensPrecio extends AbstractCellEditor implements TableCellEditor{
    ...
    public MyTableCellEditorConsolMensPrecio(database db, String NameColumn)
    {
            this.db = db;
    ...
    public boolean stopCellEditing() {
        ...
        {   //Realiza la actualizacion
            if( !db.updatePrecioServicioMensual(NewValue, ID ) )
