...
public class MyTableCellEditorServRutNombre extends AbstractCellEditor implements TableCellEditor{
    ...
    public MyTableCellEditorServRutNombre(database db, String NameColumn)
    {
            this.db = db;
