...
public class MyTableCellEditorConsM extends AbstractCellEditor implements TableCellEditor{
    ...
    public MyTableCellEditorConsM(database db, String NameColumn)
    {
            this.db = db;
...
//            transporte = table.getValueAt(row,3).toString();//obtiene el ID unico del registro
    ...
    public boolean stopCellEditing() {
        ...
        {   //Realiza la actualizacion
            if( !db.updateCotizacionConsolidadoM(NameColum+"='"+NewValue+"' ", ID ) )
