...
public class MyTableCellEditorCotiRentaPrecio extends AbstractCellEditor implements TableCellEditor{
    ...
    public MyTableCellEditorCotiRentaPrecio(database db, String NameColumn)
    {
            this.db = db;
    ...
    public boolean stopCellEditing() {
        ...
        {   //Realiza la actualizacion
            if( !db.updateCotizacionRenta(NameColum+"='"+NewValue+"' ", ID ) )
