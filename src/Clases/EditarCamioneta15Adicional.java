...
public class EditarCamioneta15Adicional extends AbstractCellEditor implements TableCellEditor{
    ...
    public EditarCamioneta15Adicional(database db, String NameColumn)
    {
            this.db = db;
    ...
    public boolean stopCellEditing() {
        ...
        {   //Realiza la actualizacion
            if( !db.updateCamioneta15(NewValue, ID ) )
