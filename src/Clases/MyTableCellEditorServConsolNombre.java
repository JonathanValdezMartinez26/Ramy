...
public class MyTableCellEditorServConsolNombre extends AbstractCellEditor implements TableCellEditor{
    ...
    public MyTableCellEditorServConsolNombre(database db, String NameColumn)
    {
            this.db = db;
