...
import static Ventanas.Modulo_Configuracion.pnlIncrementoPrecios.tabla;
 ...
 * @author jona
 */
public class EstiloTablaRendererConfiguracion extends DefaultTableCellRenderer {
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
        ...
        if(tabla.getValueAt(row, 7).toString().equals("VENCIDA"))
        {
        ...
        {
            if(tabla.getValueAt(row, 7).toString().equals("PROXIMA A VENCER"))
            {
            ...
            {
                if(tabla.getValueAt(row, 7).toString().equals("VIGENTE"))
                {
