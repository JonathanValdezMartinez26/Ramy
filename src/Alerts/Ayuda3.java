...
public class Ayuda3 extends javax.swing.JDialog {

    public Ayuda3(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel2.add(info, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 134, 230, 20));
        ...
        info2.setText("   con hacer doble clic sobre la tabla ");
        ...
        info4.setText("   en  la  consulta  qué   le  gustaría  ");
        ...
        info6.setText("   Para observar  una  receta  basta ");
        ...
        jPanel2.add(info7, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 120, 230, 20));

        info8.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        info8.setText("   a Servicios Promedic.");
        jPanel2.add(info8, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 148, 230, 20));
