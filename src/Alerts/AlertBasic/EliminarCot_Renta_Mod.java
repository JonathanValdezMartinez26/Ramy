...
public class EliminarCot_Renta_Mod extends javax.swing.JDialog {

    public EliminarCot_Renta_Mod(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EliminarCot_Renta_Mod dialog = new EliminarCot_Renta_Mod(new javax.swing.JFrame(), true);
