...
public class EliminarRut extends javax.swing.JDialog {

    public EliminarRut(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        this.dispose();
    ...
    private void log2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_log2ActionPerformed
      ...
      this.dispose();
      Opciones.eliminarCotizacionR(IDD);
      Opciones.listar("", IDD);              
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EliminarRut dialog = new EliminarRut(new javax.swing.JFrame(), true);
