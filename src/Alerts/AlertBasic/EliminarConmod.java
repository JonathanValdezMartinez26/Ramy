...
public class EliminarConmod extends javax.swing.JDialog {

    public EliminarConmod(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EliminarConmod dialog = new EliminarConmod(new javax.swing.JFrame(), true);
