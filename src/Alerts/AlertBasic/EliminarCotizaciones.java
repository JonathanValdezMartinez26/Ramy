...
public class EliminarCotizaciones extends javax.swing.JDialog {

    public EliminarCotizaciones(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EliminarCotizaciones dialog = new EliminarCotizaciones(new javax.swing.JFrame(), true);
