...
import Ventanas.Modulo_Ruta_Cotizacion.Opciones;
import com.sun.glass.events.KeyEvent;
import java.awt.event.WindowEvent;
import javax.swing.JOptionPane;
import necesario.RSAWTUtilities;

public class EliminarRutMod extends javax.swing.JDialog {

    public EliminarRutMod(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        this.dispose();
    ...
    private void log2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_log2ActionPerformed
      ...
      this.dispose();
      Opciones.eliminarCotizacionRM(IDD);
      Opciones.listarModificar("", IDD);              
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EliminarRutMod dialog = new EliminarRutMod(new javax.swing.JFrame(), true);
