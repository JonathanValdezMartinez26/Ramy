...
public class Eliminar1 extends javax.swing.JDialog {

    public Eliminar1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/icons8-borrar-para-siempre-60.png"))); // NOI18N
        ...
        msj1.setText("¿Desea eliminar el Registro?");
        ...
        jPanel1.add(log2, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 90, 140, 30));

        msj2.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        msj2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        msj2.setText("El registro no podra recuperarse");
        ...
        jPanel1.add(log3, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 90, 140, 30));
        jPanel1.add(ID, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 10, 30, 10));
        jPanel1.add(Cotizacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 120, 40, 10));
    ...
    private void log2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_log2ActionPerformed
        ...
        Ventanas.Modulo_Cotizaciones.Opciones.listarModificar("", I);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Eliminar1 dialog = new Eliminar1(new javax.swing.JFrame(), true);
    ...
    public static javax.swing.JLabel Cotizacion;
