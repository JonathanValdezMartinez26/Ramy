...
public class Ayuda2 extends javax.swing.JDialog {

    public Ayuda2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        info2.setText("   basta  con  dar doble clic  sobre el");
        ...
        info3.setText("   médico o establecimiento.  ");
        ...
        info4.setText("   registro de la consulta, qué realizo  ");
        ...
        info5.setText("   anteriormente la recepción del   ");
        ...
        info6.setText("  Para  atender   una  consulta, solo");
        jPanel2.add(info6, new org.netbeans.lib.awtextra.AbsoluteConstraints(4, 31, 220, 26));
